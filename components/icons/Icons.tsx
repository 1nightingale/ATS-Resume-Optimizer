...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075c0 1.313-.964 2.446-2.25 2.611a48.455 48.455 0 0 1-1.44 0H7.44a48.455 48.455 0 0 1-1.44 0c-1.286-.165-2.25-1.298-2.25-2.611v-4.075m16.5 0a2.25 2.25 0 0 0-2.25-2.25H5.25a2.25 2.25 0 0 0-2.25 2.25m16.5 0v-6.75a2.25 2.25 0 0 0-2.25-2.25H16.5a2.25 2.25 0 0 0-2.25 2.25v6.75m-6.75 0v-6.75a2.25 2.25 0 0 0-2.25-2.25H5.25a2.25 2.25 0 0 0-2.25 2.25v6.75m6.75-6.75h3.75" />
    </svg>
);
